...
class Koleksi extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'klarifikasi_id' => ['type' => 'int', 'constraint' => 10, 'unsigned' => true,],
            ...
            'eksempler'      => ['type' => 'int', 'constraint' => 10],
        ...
        $this->forge->addForeignKey('kategori', 'kategori', 'id', 'cascade', 'set null');
        $this->forge->addForeignKey('bahasa_id', 'bahasa', 'id', 'cascade', 'set null');
        $this->forge->addForeignKey('pustawakan_id', 'pustawakan', 'id', 'cascade', 'set null');
